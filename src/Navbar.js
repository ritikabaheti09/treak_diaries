  ...
  return (
    ...
    <div className='shadow-md w-full fixed top-0 left-0'>
      <div className='md:flex items-center justify-between bg-white py-4 md:px-10 px-7'>
            ...
            <Link to = '/Home'><li  className='md:ml-8 text-xl md:my-0 my-7'>
                        <a  className='text-gray-800 hover:text-gray-400 duration-500 cursor-pointer'>Home</a>
                    </li></Link>
                    <li  className='md:ml-8 text-xl md:my-0 my-7'>
                        <a  className='text-gray-800 hover:text-gray-400 duration-500 cursor-pointer'>Upcoming treak </a>
                    </li>
                    <li  className='md:ml-8 text-xl md:my-0 my-7'>
                    ...
                    <li  className='md:ml-8 text-xl md:my-0 my-7'>
                        <a  className='text-gray-800 hover:text-gray-400 duration-500 cursor-pointer'>City</a>
                    </li>        
            </ul>
      </div>
    </div>
